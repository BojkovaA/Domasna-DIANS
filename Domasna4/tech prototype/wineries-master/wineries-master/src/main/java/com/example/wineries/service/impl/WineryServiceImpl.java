...
public class WineryServiceImpl implements WineryService {
    ...
    @Override
    public void saveWinery(Long id, String name, Double lat, Double lon, String city) {
        if (wineryRepository.findById(id).isPresent()) {
            try {
        ...
        Winery winery = new Winery(id, name, lat, lon, city);
    ...
    public Winery findClosestTo(Winery w) {
        ...
        return wineryRepository.getById(idOfClosest);
    }
